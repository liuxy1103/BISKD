...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--cfg', type=str, default='baseline_emb16_mutex_aff_w1_graph_KD_T2_S1_w200_node0.01_edge0.5_single', help='path to config file')
    parser.add_argument('-mn', '--model_name', type=str, default='2022-02-02--10-46-24_baseline_emb16_mutex_aff_w1_graph_KD_T2_S1_w200_node0.01_edge0.5_single')
    parser.add_argument('-id', '--model_id', type=int, default=321000)
    ...
    parser.add_argument('-sel', '--show_embedding_layers', action='store_true', default=True)
